...
image = pygame.image.load("images/pacthonload.png")
class Player:
    def __init__(self, app, pos, image):
        self.app = app
    ...
    def update(self):
        ...
        if self.on_coin():
            self.eat_coin()
    def draw(self):
        pygame.draw.circle(self.app.screen, WHITE, (int(self.pix_pos.x), int(self.pix_pos.y)), self.app.cell_width//2-2)
